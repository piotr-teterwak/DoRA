...
CUDA_VISIBLE_DEVICES=$4 python   finetune.py   \
    ...
    --learning_rate $5 --cutoff_len 256 --val_set_size 120 \
    --eval_step 80 --save_step 80  --adapter_name hyperdora \
    --target_modules '["q_proj", "k_proj", "v_proj", "up_proj", "down_proj"]' \
    --lora_r $1 --lora_alpha $2 --use_gradient_checkpointing --input_std $6
